...
import { 
  ...
  UserPlus, Eye, EyeOff, ArrowRight, Loader2 
} from 'lucide-react';
...
export const LoginPage: React.FC = () => {
  ...
  if (isForgotPassword) {
    return (
      <div className="flex min-h-screen w-full items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-zinc-950 dark:to-zinc-900 p-4">
        <div className="w-full max-w-[440px]">
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-gray-200 dark:border-zinc-800 shadow-xl p-6">
