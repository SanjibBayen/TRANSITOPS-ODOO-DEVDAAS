        ...
        <div className="hidden lg:flex lg:w-[42%] relative flex-col justify-between bg-gradient-to-br from-[#3d2a38] via-[#4a2e44] to-[#714B67] p-10 overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="grid grid-cols-3 gap-3 mb-5 pb-5 border-b border-white/10">
              <div>
                <span className="text-lg font-black text-white block">2,400+</span>
                <span className="text-[9px] font-semibold text-white/50 uppercase tracking-wider">Drivers</span>
              </div>
              <div>
                <span className="text-lg font-black text-white block">99.9%</span>
                <span className="text-[9px] font-semibold text-white/50 uppercase tracking-wider">Uptime</span>
              </div>
              <div>
                <span className="text-lg font-black text-white block">180+</span>
                <span className="text-[9px] font-semibold text-white/50 uppercase tracking-wider">Operators</span>
              </div>
            </div>
            <div className="flex items-center gap-2 text-white/40 text-[9px] font-semibold">
              <CheckCircle2 className="h-3 w-3" />
              SOC 2 Type II certified · v4.2
