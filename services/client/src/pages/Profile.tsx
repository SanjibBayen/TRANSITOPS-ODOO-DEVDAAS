        ...
        <div className="md:col-span-2 space-y-6">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            <div className="bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-800 p-4 shadow-sm">
              ...
              <span className="text-2xl font-black text-[#714B67] block mt-1">
                {stats.safetyScore}%
              </span>
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-800 p-4 shadow-sm">
              ...
              <span className="text-2xl font-black text-gray-900 dark:text-zinc-100 block mt-1">
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-800 p-4 shadow-sm">
              ...
              <span className="text-xl font-black text-gray-900 dark:text-zinc-100 block mt-1">
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-800 p-4 shadow-sm">
              ...
              <span
                className={`text-lg font-black block mt-1 ${stats.status === "AVAILABLE" ? "text-green-600" : stats.status === "ON_TRIP" ? "text-blue-600" : "text-gray-600"}`}
              >
                {stats.status}
              </span>
              <span className="text-[9px] font-bold text-gray-500 mt-1">
                {stats.licenseCategory}
              </span>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-800 p-5 shadow-sm space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
              <div className="p-3 bg-gray-50 dark:bg-zinc-800 rounded-lg">
                ...
                <p className="font-extrabold text-gray-900 dark:text-zinc-100 mt-1 font-mono">
                  {stats.licenseNumber}
                </p>
              </div>
              ...
              <div className="p-3 bg-gray-50 dark:bg-zinc-800 rounded-lg">
                ...
                <div className="flex items-center gap-2 mt-1">
                  <p className="font-extrabold text-gray-900 dark:text-zinc-100">
                    {stats.licenseExpiry}
                  </p>
                ...
                {daysUntilExpiry !== null && (
                  <span
                    className={`text-[10px] font-bold ${daysUntilExpiry <= 7 ? "text-red-600" : daysUntilExpiry <= 30 ? "text-amber-600" : "text-emerald-600"}`}
                  >
